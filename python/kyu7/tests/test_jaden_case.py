...
from kyu7.jaden_casing_strings import to_jaden_case
...
def test_jaden_case():
    ...
    assert_equal(to_jaden_case(quote), "How Can Mirrors Be Real If Our Eyes Aren't Real")


try:
    to_jaden_case2 = to_jaden_case
except NameError:
    pass
...
for i in quotes:
    assert_equal(to_jaden_case(i[0]), i[1])
