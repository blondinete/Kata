...
import main.kyu6.BouncingBalls;
...
public class BouncingBallsTest {
	...
	@Test
	public void test3() {
		assertEquals(21, BouncingBalls.bouncingBall(30, 0.75, 1.5));
	}
	@Test
	public void test4() {
		assertEquals(3, BouncingBalls.bouncingBall(30, 0.4, 10));
	}
	@Test
	public void test5() {
		assertEquals(3, BouncingBalls.bouncingBall(40, 0.4, 10));
	}
	@Test
	public void test6() {
		assertEquals(-1, BouncingBalls.bouncingBall(10, 0.6, 10));
	}
	@Test
	public void test7() {
		assertEquals(-1, BouncingBalls.bouncingBall(40, 1, 10));
	}
	@Test
	public void test8() {
		assertEquals(-1, BouncingBalls.bouncingBall(-5, 0.66, 1.5));
	}
	@Test
	public void test9() {
		assertEquals(-1, BouncingBalls.bouncingBall(5, -1, 1.5));
	}
	...
	public void test() {
		...
		for (int k = 0; k < 10; k++) {
			...
			assertEquals(BouncingBallsTest.bouncingBallTest(f1, f2, f3), BouncingBalls.bouncingBall(f1, f2, f3));
		}
	}
